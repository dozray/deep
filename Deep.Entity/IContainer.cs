...
//  --------------------------------------------------------------------------------------------
//  File Name : IContainer 
//  CLR Version : 2.0.50727.3623
//  Create At : MATRIX   2011-7-22 11:28:09 
...
namespace deep.entity
{
    ...
    ///  处理有包含关系中的容器的接口
    /// </summary>
    /// <typeparam name="T">实现了ISequence接口的类</typeparam>

    public interface IContainer<T> : ICode where T : ISequence
    {
        /// <summary>
        /// 对象所拥有的成员列表
        /// </summary>
        IList<T> Members { get; set; }
    }
}
